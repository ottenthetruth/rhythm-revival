async function authforhomepage() {
  ...
  const spotifyAuthURL = `https://accounts.spotify.com/authorize?client_id=${clientID}&response_type=code&redirect_uri=${redirectURI}&scope=user-library-read%20playlist-read-private%20user-read-currently-playing&state=${callbackURL}`;
